      ...
      <div style={{ padding: 20 }}>
        ...
        <Grid container
          ...
          <Grid item xs={8} textAlign="left">
            <Typography variant="body1" marginBottom={2.5}>물품 명 : 000</Typography>
            <Typography variant="body1" marginBottom={2.5}>목표 가격 : 00,000원</Typography>
            <Typography variant="body1" marginBottom={2.5}>남은 금액 : 00,000원</Typography>
            <LinearProgress variant="determinate" value={30} sx={{ width: "50%", height: 15, mb: 2.5}}/>

            {donate ? (

              <Grid container style={{justifyContent: 'flex-start', alignItems: 'center', marginBottom:'10px' }}>
              <Grid item xs={6} md={6}>
                {options.map((option) => (
                  <div key={option}>
                    <label>
                ...
                <Grid item xs={6} md={6}>
                  <Button sx={{bgcolor: 'blue', color:'black'}} onClick={diffPoint} >결제하기</Button>
                </Grid>
            </Grid>
                ) : null}
        ...
        <Grid container justifyContent='flex-end'>
            <Button sx={{bgcolor: 'blue', color:'black'}} onClick={handleToggle}>후원하기</Button>
            <Button sx={{bgcolor: 'red', color:'black'}}>돌아가기</Button>
            <Button sx={{bgcolor: 'blue', color:'black'}}>수정</Button>
            <Button sx={{bgcolor: 'red', color:'black'}} disableRipple>삭제</Button>
        </Grid>
        </Grid>
      </Container>
    </>
