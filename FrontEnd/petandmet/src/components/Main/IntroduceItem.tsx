...
function IntroduceItem({ animal }: AnimalIntroduceInfoProps) {
  ...
  const character = animal.character == "ACTIVE" ? "활발한" : animal.character == "PEACE" ? "평온한" : "민감한"

  return (
    <>
      <div className="overflow-hidden w-[150px] overflow-hidden bg-white/75 rounded-xl cursor-pointer">
        <div className="">
          <div className="">
            <div>
              <img
            ...
            <div className="text-sm flex flex-col justify-between">
              <div className="">{animal.name}({animal.age}세)</div>
