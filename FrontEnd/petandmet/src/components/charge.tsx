...
function Charge() {
  ...
  return (
    ...
    <ThemeProvider theme={theme}>
        ...
        <div style={{ backgroundColor: '#FFE8A3', borderRadius: 20 }}>
          <Container style={{fontSize: '3rem'}}>
            <Grid container style={{ padding: 10, color: 'white' }}>
              ...
              <Grid item xs={1} md={1} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', color: 'black' }}>
                +
              </Grid>
              <Grid item xs={3} md={3} style={{ backgroundColor: '#FFA629', borderRadius: 5 }}>
          ...
          <Container>
            <Grid container style={{justifyContent: 'center', alignItems: 'center', marginBottom:'10px' }}>
              <Grid item xs={6} md={6}>
                {options.map((option) => (
                  <div key={option}>
                    <label>
              ...
              <Grid item xs={6} md={6} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '10px' }}>
      ...
      <Button variant="contained" style={{backgroundColor : '#FFA629', marginTop:'10px'}}>
        결제하기
      </Button>
    </ThemeProvider>
    </div>
