...
import { AnimalUpdate } from "hooks/Center/CenterAnimal";
...
function UpdateCenterAnimal() {
    ...
    const goToUpdate = async () => {
        ...
        await AnimalUpdate(updatedData, accessToken, domain)
        navigate(-1)
      };
...
export default UpdateCenterAnimal;
export{};
